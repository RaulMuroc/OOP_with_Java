...
*/
@Override protected void emergencyMeeting() {
     if (!this.isFrozen()) {
...
The player that has the highest susLevel (that is NOT the current impostor calling the meeting) will be accused of being the impostor 
